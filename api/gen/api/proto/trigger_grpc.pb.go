...
const (
	TriggerService_ListTriggers_FullMethodName  = "/api.TriggerService/ListTriggers"
	TriggerService_AddTrigger_FullMethodName    = "/api.TriggerService/AddTrigger"
	TriggerService_UpdateTrigger_FullMethodName = "/api.TriggerService/UpdateTrigger"
	TriggerService_RemoveTrigger_FullMethodName = "/api.TriggerService/RemoveTrigger"
)
...
func (c *triggerServiceClient) AddTrigger(ctx context.Context, in *AddTriggerRequest, opts ...grpc.CallOption) (*AddTriggerResponse, error) {
	...
	err := c.cc.Invoke(ctx, TriggerService_AddTrigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *triggerServiceClient) RemoveTrigger(ctx context.Context, in *RemoveTriggerRequest, opts ...grpc.CallOption) (*RemoveTriggerResponse, error) {
	...
	err := c.cc.Invoke(ctx, TriggerService_RemoveTrigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TriggerService_AddTrigger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TriggerService_AddTrigger_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TriggerService_RemoveTrigger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TriggerService_RemoveTrigger_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
